...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Validasi form
    if (!formData.name || !formData.no_telepon || !formData.message) {
    ...
    const message = `Nama: ${formData.name}%0ANo. Telepon: ${formData.no_telepon}%0APesan: ${formData.message}`;
    ...
    // Opsional: Tetap kirim form ke getform.io jika diperlukan
    // Bisa dihapus jika hanya ingin mengirim ke WhatsApp
